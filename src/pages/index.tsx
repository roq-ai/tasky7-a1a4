  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Tasky7, your ultimate todo list app. Simplifying your daily tasks, enhancing productivity, and transforming the way you organize your life."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Tasky7, your ultimate todo list app. Simplifying your daily tasks, enhancing productivity, and transforming the way you organize your life.`}
            </Text>
            <Box
